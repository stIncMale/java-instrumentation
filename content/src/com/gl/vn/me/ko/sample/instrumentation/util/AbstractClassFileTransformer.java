...
public abstract class AbstractClassFileTransformer implements ClassFileTransformer {
	 ...
	 * <p/>
	 * The method returns null if no transformation is needed, otherwise it returns an array of bytes in class file format as specified in "The Java Virtual Machine Specification".
	 * 
	 * @param classLoader
	 *            The defining loader of the class to be transformed, may be null if the bootstrap loader.
	 * @param className
