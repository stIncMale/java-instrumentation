...
final class MethodInterceptorExampleB implements MethodInterceptor {
	 ...
	 * 
	 * @return
	 *         Result of the original method invocation or negated value of the original result if it's of type {@link java.math.BigDecimal}.
	...
	public final Object intercept(final Object proxyObject, final Method method, final Object[] methodArgs, final MethodProxy proxyMethod) throws Throwable {
		...
		final boolean returnValueIsBigDecimal = returnValueFromOriginalMethod instanceof BigDecimal;
		final String stringRepresentationOfReturnValue = returnValueIsBigDecimal ? numberFormat.format(returnValueFromOriginalMethod) : returnValueFromOriginalMethod.toString();
		final Object result;
