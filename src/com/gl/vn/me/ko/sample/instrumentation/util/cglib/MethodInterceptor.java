...
@edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "NM_SAME_SIMPLE_NAME_AS_INTERFACE",
		justification = "Name is made intentionally the same as the name of implemented interface because this derived interface provides only additional documentation and no any new functionality")
public interface MethodInterceptor extends net.sf.cglib.proxy.MethodInterceptor {
	/**
	 * All proxy methods of proxy object generated with method interceptor invoke this method instead of the original one. Note that CGLib can generate proxy methods only for non-final and
	 ...
	 * @return
	 *         Any value compatible with the signature of the proxied method (can be {@code null}). Method returning void will ignore this value.
	 * @throws java.lang.Throwable
	 *             If something goes wrong.
	 */
	@Nullable
	public Object intercept(@SuppressWarnings("null") final Object proxyObject, @SuppressWarnings("null") final Method method, @SuppressWarnings("null") final Object[] methodArgs,
