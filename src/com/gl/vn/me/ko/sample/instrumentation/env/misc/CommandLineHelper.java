...
public final class CommandLineHelper {
  ...
  public final static class CommandLineParams {
    /**
     * This class provides a method to convert a value of command-line argument
     * into Java-object with the same type as {@link CommandLineParams#exampleName} field.
     * <p>
    ...
    public final static class ExampleNameConverter implements IStringConverter<String> {
      ...
      /**
       * Converts {@link java.lang.String} object into another {@link java.lang.String} object
       * that can be used as value of {@link CommandLineParams#exampleName} field.
       *
       * @param paramValue {@link java.lang.String} object to convert. Can be {@code null}.
       *
       * @return Converted {@link java.lang.String} object.
       */
      public final String convert(@Nullable final String paramValue) {
        return (paramValue == null ? "" : paramValue.toUpperCase(Internationalization.LOCALE));
      }
    }

    /**
     * This class provides a method to convert a value command line-argument into Java-object with the same type as
     * {@link CommandLineParams#logLevel} field.
     * <p>
     * Instantiability: allowed.<br>
     * Mutability: immutable.<br>
     * Thread safety: thread-safe.
    ...
    public final static class LogLevelConverter implements IStringConverter<Level> {
       ...
       * Constructs an instance of {@link LogLevelConverter}.
       *
       * @param calledFromAgent Specifies if the constructor was called from Java-agent class or from main class of the application.
      ...
      /**
       * Converts {@link java.lang.String} object into {@link org.apache.log4j.Level} object that can be used as value of
       * {@link CommandLineParams#logLevel} field.
       *
       * @param paramValue {@link java.lang.String} object to convert. Can be {@code null}.
       *
       * @return Converted {@link org.apache.log4j.Level} object.
       *
       * @throws com.beust.jcommander.ParameterException If the specified {@link java.lang.String} can't be converted into
     ...
     */
    @Parameter(names = {"-logLevel", "-logl"},
        description = "Level of logging (possible values: INFO, DEBUG, TRACE)",
        converter = LogLevelConverter.class)
    public Level logLevel;
    /**
     * Definition of command-line argument that specifies name of the example to launch.
     */
    @Parameter(names = {"-example", "-ex"},
        description = "Name of the example to launch (possible values: A, B, C, D)",
        required = true,
        converter = ExampleNameConverter.class)
   ...
   *
   * @param args Command-line arguments of the application. Must be not {@code null}.
   *
   * @return Object that contains values of processed command-line arguments.
   */
  @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "DLS_DEAD_LOCAL_STORE",
      justification = "JCommander API forces such an uncommon constructor invocation")
  public final static CommandLineParams getCommandLineParams(final String[] args) {
    ...
    @SuppressWarnings("unused") final Object deadStore = new JCommander(clParams, args);
    return clParams;
  }
   ...
   *
   * @param cause Exception that caused invocation of the method. Must be not {@code null}.
   */
  public final static void printAgentUsageAndExit(final ParameterException cause) {
    ...
    final String usage =
        "Usage: -javaagent:agent.jar[=options]" + lineSeparator + "  One can optionally specify a level of logging of the agent" + lineSeparator +
