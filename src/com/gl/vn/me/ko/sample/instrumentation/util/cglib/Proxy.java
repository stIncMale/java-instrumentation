...
public final class Proxy {
	 ...
	 * Provided {@code callback} will be used for every invocation of any non-final and non-private method inherited from {@code superclass} and {@code interfaces}.
	 * <p>
	 ...
	 *
	 * @param <T>
	 *   					A type/supertype of {@code superclass} or type/supertype of any interface in {@code interfaces}. The returned object can be explicitly cast to any type that
